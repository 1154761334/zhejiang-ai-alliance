...
┌─────────────────────▼────────────────────────────────────┐
│                    Next.js 前端门户                       │
│  - 营销页面: /, /blog, /pricing, /join, /docs            │
│  - 服务大厅: /services (算力服务, 模型精调, 动态标杆案例直连) │
│  - 成员中心: /dashboard (企业四步向导填报)                 │
│  - 秘书处端: /admin (运营大屏 + A/B/C 三层结构企业管理台)   │
└─────────────────────┬────────────────────────────────────┘
                      │ @directus/sdk (REST API)
┌─────────────────────▼────────────────────────────────────┐
│                   Directus 核心后端                       │
│  - 权限控制: RBAC (Admin/User 角色隔离)                   │
│  - 内容管理: Articles, Media, Settings                    │
│  - 业务逻辑: Companies, Products, Cases, Needs            │
└─────────────────────┬────────────────────────────────────┘
                      │
┌─────────────────────▼────────────────────────────────────┐
│                  存储层 (Docker Volumes)                  │
│  - Database: data.db (SQLite)                             │
│  - Assets: /uploads (企业 Logo, 证明材料)                 │
└──────────────────────────────────────────────────────────┘
```

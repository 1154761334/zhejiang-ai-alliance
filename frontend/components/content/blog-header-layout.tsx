    ...
    <>
      <MaxWidthWrapper className="py-6 md:pb-8 md:pt-10">
        ...
        <nav className="mt-8 hidden w-full md:flex">
          ...
          >
            <CategoryLink title="全部" href="/blog" active={!slug} />
            ...
            <CategoryLink title="使用指南" href="/guides" active={false} />
          </ul>
        </nav>
      </MaxWidthWrapper>
      ...
      <Drawer.Root open={open} onClose={closeDrawer}>
        ...
        >
          ...
          <p className="ml-2.5 text-sm font-medium">分类筛选</p>
        </Drawer.Trigger>
